    ...
    <div className="fixed inset-0 z-50 bg-[#06060c]/85 backdrop-blur-md flex items-center justify-center p-4">
      <div className="relative w-full max-w-md bg-[#0f0f1c]/95 border border-white/10 rounded-2xl p-6 sm:p-8 shadow-2xl flex flex-col justify-between overflow-hidden">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4 text-left">
          ...
          {errorMsg && (
            <div className="bg-red-950/40 border border-red-800/20 text-red-400 text-xs p-3 rounded-xl flex flex-col gap-2 leading-relaxed">
              ...
              {(errorMsg.includes("unauthorized-domain") || errorMsg.includes("Firebase Auth Error")) && (
                <div className="mt-1 border-t border-red-800/25 pt-2 flex flex-col gap-2">
                  ...
                  <button
                    ...
                    className="w-full bg-cyan-400 hover:bg-cyan-300 text-slate-950 font-bold text-[10px] font-mono py-2 px-3 rounded-lg transition-all text-center uppercase tracking-wider"
                  >
